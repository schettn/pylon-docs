...
<Callout>
Pylon also offers a strong type support including generics, static functions, and more. Therefore it can also handle Prisma models and other complex types.
