...
<Callout>
Pylon also offers a strong type support including generics, static functions, function arguments, and more. Therefore it can also handle Prisma models and other complex types.
See [Prisma Integration](./integrations/databases.mdx#using-prisma) for more information.
</Callout>
